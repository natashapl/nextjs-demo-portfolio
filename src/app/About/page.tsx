  ...
  return (
    <>
      ...
      <main className="max-w-4xl w-full p-10">
        ...
        <p className="mb-6">
          This <strong>Next.js portfolio demo</strong> was built as part of my learning journey into modern React frameworks. It is a fully dynamic portfolio site powered by <strong>Next.js, Tailwind CSS,</strong> and <strong>Contentful</strong> as a headless CMS.
        </p>
